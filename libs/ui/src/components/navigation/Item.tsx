...
export const Item = React.forwardRef<HTMLLIElement, ItemProps>(({ link, children }, ref) => {
  ...
  return (
    <li ref={ref} className="flex items-center">
      <NavLink
        to={link}
        className={({ isActive }) =>
          clsx(isActive && activeClass, 'block py-2 px-3 rounded md:bg-transparent md:p-0 w-full')
        }
      >
        {children}
      </NavLink>
